...
public class CityNoAreaPicker extends LinearLayout {
    /**
     * 滑动控件
     */
     ...
     * 选择监听
     */
    private JJTPicker.OnSelectingListener onSelectingListener;
    /**
     * 刷新界面
     */
    ...
    public CityNoAreaPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CityNoAreaPicker(Context context) {
        super(context);
        this.context = context;
        getaddressinfo();
        // TODO Auto-generated constructor stub
...
//                    System.out.println("endselect");
    ...
    public void setOnSelectingListener(JJTPicker.OnSelectingListener onSelectingListener) {
