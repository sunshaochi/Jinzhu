...
public class ShenSiPicker extends LinearLayout{
    /**
     * 滑动控件
     */
    ...
    public ShenSiPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ShenSiPicker(Context context) {
        super(context);
        this.context = context;
        getaddressinfo();
        // TODO Auto-generated constructor stub
...
//                    System.out.println("endselect");
    ...
    public void setOnSelectingListener(ShenSiPicker.OnSelectingListener onSelectingListener) {
