...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	protected void pullHeaderLayout(float delta) {
		...
		if (onPullOffset != null) {
			onPullOffset.onPullOffset(-getScrollYValue());
		}
	...
	final class SmoothScrollRunnable implements Runnable {
		...
		public void run() {
			...
			if (mStartTime == -1) {
				...
				if (onPullOffset != null) {
					onPullOffset.onPullOffset(-mCurrentY);
				}
			}
	...
	private OnPullOffset onPullOffset;

	public void setOnPullOffset(OnPullOffset onPullOffset) {
		this.onPullOffset = onPullOffset;
	}
	 ...
	 * 
	 */
	public static interface OnPullOffset {
		/**
		 * 下拉位移变化设置
		 * 
		 * @param offset
		 */
		public void onPullOffset(float offset);
		 ...
		 * @param offset
		 */
		public void onFinishPull(float offset);
