...
import com.beyonditsm.financial.view.wheelView.adapters.WheelViewAdapter;
 ...
 */
public class CoustomerWheelView extends View {
    ...
    private CoustomerWheelScroller scroller;
    ...
    public CoustomerWheelView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initData(context);
    }

    public CoustomerWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }

    public CoustomerWheelView(Context context) {
        super(context);
        initData(context);
    }

    private void initData(Context context) {
        scroller = new CoustomerWheelScroller(getContext(), scrollingListener);
    }

    CoustomerWheelScroller.ScrollingListener scrollingListener = new CoustomerWheelScroller.ScrollingListener() {
        @Override
        ...
        public void onJustify() {
            if (Math.abs(scrollingOffset) > CoustomerWheelScroller.MIN_DELTA_FOR_SCROLLING) {
