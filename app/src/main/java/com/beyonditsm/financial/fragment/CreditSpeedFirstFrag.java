...
public class CreditSpeedFirstFrag extends BaseFragment {
    ...
    private int i = 60;
    private Timer timer;
    private CreditSpeedFirstFrag.MyTimerTask myTask;
    ...
    public View initView(LayoutInflater inflater) {
        view = View.inflate(context, R.layout.frag_creditspeedfirst, null);
        assignViews();
        return view;
    }
                ...
                generalUtil.setiCode(new GeneralUtils.ICode() {
                    ...
                    public void isSucess(int flag) {
                        if(flag==1){
                            ...
                            timer = new Timer();
                            myTask = new CreditSpeedFirstFrag.MyTimerTask();
...
//                    String roleName = data.optString("roleName");
                    ...
                    EventBus.getDefault().post(new CreditSpeedStepAct.FirstEvent(1,null));
